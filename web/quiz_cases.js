...
{ id: 3, cat: 'num_auto', iscn: '47,XY,+13',
  ...
  sub: [
    ...
    { q: 'Warum ist die Abklaerung des Translokationstyps wichtig?', choices: ['Wiederholungsrisiko haengt vom Mechanismus ab: rob(13;13) = 100%!', 'Therapie unterscheidet sich', 'Prognose ist besser bei Translokation', 'Kein Unterschied'], answer: 0, explain: 'Freie Trisomie: ~1%. rob(13;14)-Traeger: ~1% (Mutter) bzw. <1% (Vater) — nur marginal erhoeht. ABER: rob(13;13) = 100% Trisomie 13 bei Nachkommen! Daher: Mechanismus-Klaerung entscheidend.' },
...
{ id: 9, cat: 'num_sex', iscn: '47,XYY',
  ...
  sub: [
    ...
    { q: 'Wie haeufig ist 47,XYY?', choices: ['~1:1000 Jungen', '~1:100.000', '~1:5.000.000', 'Extrem selten'], answer: 0, explain: '~1:1000 maennliche Geburten. Klinefelter ist haeufiger (~1:660), aber XYY wird viel seltener diagnostiziert wegen des milden Phaenotyps.' },
...
{ id: 32, cat: 'iso_ring', iscn: '46,XY,r(13)', img: 'img/quiz/case_48_ring_chr.jpg',
  ...
  sub: [
    ...
    { q: 'Warum aehnelt r(13) partiell der Trisomie 13?', choices: ['Falsch — r(13) aehnelt einer 13q-Deletion (Material geht verloren)', 'Weil zusaetzliches Material vorhanden ist', 'Durch Mosaikeffekte', 'Zufaellige Aehnlichkeit'], answer: 0, explain: 'r(13) = terminale Deletion 13p + 13q. Holoprosenzephalie-Spektrum durch ZIC2-Verlust auf 13q32 (ZIC2 ist eines der HPE-Gene; SHH liegt auf 7q36, nicht auf 13q).' },
...
{ id: 34, cat: 'iso_ring', iscn: '47,XY,+mar',
  ...
  sub: [
    ...
    { q: 'Haeufigkeit von sSMC?', choices: ['~0.04% Lebendgeburten (~1:2500), ~0.075% bei Amniozentesen (~1:1300)', '1:100', '1:1.000.000', 'Extrem haeufig'], answer: 0, explain: '~1:2500 Lebendgeburten, ~1:1300 bei Amniozentesen (hoeher weil auch letale Formen erfasst). In ~70% klinisch unauffaellig (besonders wenn familiaer oder rein heterochromatisch).' }
  ]},
...
{ id: 38, cat: 'num_auto', iscn: '92,XXYY',
  ...
  sub: [
    { q: 'Was ist dieser Karyotyp?', choices: ['Tetraploidie (4n = 92)', 'Triploidie', 'Mosaik-Trisomie', 'Normale Variante'], answer: 0, explain: 'Tetraploidie: 4 vollstaendige Chromosomensaetze. Meist durch Cytokinese-Versagen nach erster Zellteilung.' },
    { q: 'Ist Tetraploidie mit dem Leben vereinbar?', choices: ['Nein, vollstaendige Tetraploidie ist immer letal', 'Ja, mit schwerer Behinderung', 'Nur als Diploid/Tetraploid-Mosaik extrem selten beschrieben', 'Ja, wie Triploidie'], answer: 2, explain: 'Vollstaendige Tetraploidie (92 Chromosomen) ist immer letal in utero. Diploid/Tetraploid-Mosaike (2n/4n) sind extrem selten dokumentiert, koennen aber begrenzt ueberleben — analog zu Triploidie-Mosaiken.' },
...
{ id: 39, cat: 'num_auto', iscn: '47,XY,+22',
  ...
  sub: [
    ...
    { q: 'Was ist die haeufigste AUTOSOMALE Trisomie bei Spontanaborten?', choices: ['Trisomie 16', 'Trisomie 21', 'Trisomie 22', 'Trisomie 13'], answer: 0, explain: 'Trisomie 16 = haeufigste autosomale Trisomie bei Aborten. Haeufigste chromosomale Anomalie insgesamt in Spontanaborten ist 45,X (~20% aller chromosomal abnormen Aborte).' }
  ]},
...
{ id: 40, cat: 'num_sex', iscn: '48,XXYY',
  ...
  sub: [
    ...
    { q: 'Entstehungsmechanismus?', choices: ['Sequentielle paternale Non-Disjunction (MI: XY-Gamet, MII: XYY-Gamet) + normales maternales X', 'Nur maternale Non-disjunction', 'Mitotisch postzygotisch', 'Immer de novo'], answer: 0, explain: 'Haeufigster Mechanismus: paternale MI-Failure (XY statt X oder Y) gefolgt von MII-Failure (XY verdoppelt sich zu XYY-Gamet). Plus normales X der Mutter = XXYY. Alternativ: Non-Disjunction in BEIDEN Eltern.' }
  ]},
